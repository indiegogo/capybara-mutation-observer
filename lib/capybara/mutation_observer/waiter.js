...
(function () {
  ...
  window.__CheckForMutations__ = function(options) {
    ...
    window._mutationState_.timer = setInterval(function() {
      ...
      debug("Skipping Mutation Observer");
  ...
  function shutdownMutationCheck() {
    ...
    setTimeout(function() {
      ...
      window._mutationState_.shutdownTime = (new Date().getTime());
      window._mutationState_.totalTime = (
        window._mutationState_.shutdownTime -
          window._mutationState_.installedTime 
      );

      debug("Mutation installedTime ["+ window._mutationState_.installedTime +"]");
      debug("Mutation shutdownTime ["+ window._mutationState_.shutdownTime +"]");
